...
@activity.defn
async def prometheuslogs(name: str) -> str:
    return f"Hello, {name}!"
...
def start_prometheus(port: int) -> Runtime:
...
async def main():
    ...
    async with Worker(
        ...
        workflows=[PrometheusWorkflow],
        activities=[prometheuslogs],
    ):
